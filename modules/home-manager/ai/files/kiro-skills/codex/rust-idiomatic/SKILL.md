...
Write idiomatic Rust when porting from C or reviewing Rust code. Covers newtypes, methods over functions, enums over booleans, iterator patterns, and the two-layer approach (C-compatible public API wrapping idiomatic internals).
