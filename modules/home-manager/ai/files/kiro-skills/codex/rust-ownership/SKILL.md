...
Ownership, borrowing, and lifetimes in Rust. Covers move semantics, references, lifetime annotations, smart pointers (Box/Rc/Arc/RefCell), interior mutability, Pin, Cow, and RAII patterns.
