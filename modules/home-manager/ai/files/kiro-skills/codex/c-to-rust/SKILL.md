...
Port C code to Rust faithfully. Covers pointer-to-reference conversion, macro-to-function translation, error handling patterns, memory management, and verification checklist.
